...
<div id="register">
	<table class="table">
		...
		<tr>
			<th>이름</th><td><input type="text" id="unm"></td>
		</tr>
		<tr>
			<th>권한</th><td><select id="auth"><option value="User">사용자</option><option value="Admin">관리자</option></select></td>
		</tr>
		<tr>
			<td><button class="btn btn-primary" id="addBtn">등록</button></td>
			<td><button class="btn btn-primary" id="remBtn">삭제</button></td>
		</tr>
	</table>
</div>
